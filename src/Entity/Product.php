...
class Product
{
    ...
    public function getIsSpeacialOffer(): ?bool
    {
        return $this->isSpeacialOffer;
    }

    public function setIsSpeacialOffer(?bool $isSpeacialOffer): self
    {
        $this->isSpeacialOffer = $isSpeacialOffer;
